...
class Lista {
    ...
    public void trocaPersonagem(int i, int j) {
...
public class PersonagemMainQ22 {
    public static void main(String[] args) throws Exception {
        ...
        listaPersonagens.ordenaInsercao(); // Ordenar os nomes para configurar a saída
        listaPersonagens.imprimir(); // Imprimir os resultados
    }
