...
public class PersonagemMainQ007 {
    public static void main(String[] args) {
        ...
        do {
            ...
            for(int i = 0; i< personagens.n; i++) {
                if(personagens.array[i].getNome().equals(busca)) {
                    encontrado = "SIM";
                    i = personagens.n;
                }
                Lista.numComparacao++;
        ...
        String conteudo = "matricula 762148 \t número de comparações " + Lista.numComparacao + " \t Tempo de execução " + tempo + " milisegundos";
