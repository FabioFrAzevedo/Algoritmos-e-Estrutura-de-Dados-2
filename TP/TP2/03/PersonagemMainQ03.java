...
class PersonagemMainQ03 extends Personagem{  
...
public static void main(String[] args) throws Exception{
    ...
    try{
        ...
        do{
            ...
            Scanner sc2 = new Scanner(arq,"ISO-8859-1");
            ...
            for(int i = 0; i <input;i++){
                ...
                if(str.charAt(0) == 'I'){
                    ...
                    switch(str.charAt(1)){
                        ...
                        Scanner sc3 = new Scanner(archive, "ISO-8859-1");
                        str = sc3.nextLine();
                        ...
                        int intTmp;
                        str = str.substring(3);
                        intTmp = Integer.parseInt(str.substring(0,2));
                        str = str.substring(3);
                        File archive2 = new File(str);
                        Scanner sc4 = new Scanner(archive2, "ISO-8859-1");
                        str = sc4.nextLine();
                        a.caminho(str);
                        lista.add(intTmp,a.clone());
                        break;
                        
                        case 'F':
                        str = str.substring(3);
                        File archive3 = new File(str);
                        Scanner sc5 = new Scanner(archive3, "ISO-8859-1");
                        str = sc5.nextLine();
                        ...
                        switch(str.charAt(1)){
                            case 'I': //remove inicio
                            str = str.substring(0);
                            // lista.remove(0);
                            System.out.println("(R) " + lista.remove(0).getNome());
                            
                            break;                
                            case '*': //remove qualquer posição
                            str = str.substring(3);
                            str = str.substring(0,str.length());
                            System.out.println("(R) " + lista.remove(Integer.parseInt(str)).getNome());
                            ...
                            break;
                            default:
                            System.out.println("error: remove elemnt");
                        }
                    }
                }
        ...
        // public void mostrarLista(ListaPersonagem lista){
            //  for (int i = 0; i < Lista.length(); i++) {J
                //  System.out.println("Nome: " + p.getNome() + ", Idade: " + p.getAnoNascimento() + ", Altura: " + p.getAltura());
       // }
       //} 
    }