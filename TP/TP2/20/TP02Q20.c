...
void ordenaInsercao(Personagem listaPersonagem[], int tamanhoVetor, int k, int *ptrComp, int *ptrMov){
...
int main(void){
    ...
    ordenaInsercao(listaPersonagem, contadorTamanho, k, ptrComp, ptrMov);
    imprimir(listaPersonagem, k); // Imprimir os resultados
